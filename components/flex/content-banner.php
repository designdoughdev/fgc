...
<section
    class="lazy slider banner row row-<?php echo $row; ?> <?php if ($size){?>full_height<?php } else { ?>half_height<?php } ?> fade-in">
...
<section
    class="banner row row-<?php echo $row; ?> <?php if ($size){?>full_height<?php } else { ?>half_height<?php } ?>">
    <div class="container">
