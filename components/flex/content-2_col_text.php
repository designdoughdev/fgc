...
<section class="full_width two-text-col row-<?php echo $row; ?> fade-in ">
        ...
        <div class="container">
            ...
            <?php if ($colcheck){?>
                ...
                <div class="one_half left">
                    ...
                    <?php if($leftlink) {?><a href="<?php echo $leftlink['url'] ?>" class="btn_default" target="<?php echo $leftlink['target'] ? $leftlink['target'] : '_self'; ?>"><?php echo $leftlink['title']; ?></a><?php }?>
                ...
                <div class="one_half left last">
                    ...
                    <?php if($rightlink) {?><a href="<?php echo $rightlink['url'] ?>" class="btn_default" target="<?php echo $rightlink['target'] ? $rightlink['target'] : '_self'; ?>"><?php echo $rightlink['title']; ?></a><?php }?>
            ...
            <?php } else { ?>
                ...
                <?php if($collink) {?><a href="<?php echo $collink['url'] ?>" class="btn_default" target="<?php echo $collink['target'] ? $collink['target'] : '_self'; ?>"><?php echo $collink['title']; ?></a><?php }?>
