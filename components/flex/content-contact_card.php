    ...
    <div class="container">
        ...
        <div class="contact_card_grid landing_page_header_fade">
            ...
            <div class="socials_wrap">
                <a class="btn_second" href="<?php echo $linkedin; ?>" target="<?php echo esc_attr( $linkedin ); ?>">
                    <span>Linkedin<img
                            src="<?php echo get_template_directory_uri() . '/assets/images/svg/arrow-right-white.svg'; ?>"
                            alt="button arrow">
                    </span>
                </a>
                <a class="btn_second" href="<?php echo $instagram; ?>" target="<?php echo esc_attr( $instagram ); ?>">
                    <span>Instagram<img
                            src="<?php echo get_template_directory_uri() . '/assets/images/svg/arrow-right-white.svg'; ?>"
                            alt="button arrow">
                    </span>
