...
<section class="full_width section_video landing_page_header_fade" id="row-<?php echo $row; ?>">

    <?php if($native_or_iframe == false) { ?>
    ...
    <video autoplay playsinline muted loop class="native_video">
