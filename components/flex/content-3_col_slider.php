...
<section
    class="col_slider row row-<?php echo $row; ?> <?php if ($size){?>break_grid<?php } else { ?>inside_grid<?php } ?>">
    ...
    <div class="regular slider">
        ...
        <div id="<?php echo $rowIndex ?>">
            <div class="slide_image_wrap <?php if ($colourselect){?>color<?php } else { ?>bandw<?php } ?>">
                <?php $bannerThreeColLeft = array(
                            'class' => '' ,
                            'id' => $image,
                            'lazyload' => false
                        );
                            echo build_srcset('banner', $bannerThreeColLeft); ?>
            </div>
    ...
    <div class="container">
        ...
        <div class="regular slider">
            ...
            <div id="<?php echo $rowIndex ?>">
                <div class="slide_image_wrap <?php if ($colourselect){?>color<?php } else { ?>bandw<?php } ?>">
                    <?php $bannerThreeColRight = array(
                                'class' => '' ,
                                'id' => $image,
                                'lazyload' => false
                            );
                                echo build_srcset('banner', $bannerThreeColRight); ?>
                </div>
